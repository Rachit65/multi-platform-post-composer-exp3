...
export const INITIAL_USERS = [
  {
    ...
    permissions: ['create_post', 'moderate_posts', 'manage_scheduled_posts', 'manage_users', 'manage_platforms', 'system_config', 'inspect_sessions'],
    status: 'active',
  ...
  },
  {
    ...
    permissions: ['create_post', 'publish_post', 'schedule_post', 'edit_own_post', 'delete_own_post', 'view_platforms'],
    status: 'active',
